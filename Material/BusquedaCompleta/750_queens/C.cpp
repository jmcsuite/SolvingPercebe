...
void print_sol(){
  cout << c << "      ";
  for(int i = 0; i<8; i++) cout << sol << (i < 7 ? " " : "\n"); //operador ternario
}

// iterar columna por columna
// si llego al final imrpimo
// si la columna, es la del input, tengo que procesar la fila del input
...
// if(x-y) == (i-j), entonces comparten d_down, [-7, 7], entonces le sumo 7
